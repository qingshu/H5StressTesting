...
type LogHandle struct {
	...
	sign             string      //左边字符标记
	isSave2LocalText bool        //是否保存日志到本地文本
}

func (this *LogHandle) Init(firstTag string, displayFile bool, s string, isSave2LocalText bool) {
	...
	this.isSave2LocalText = isSave2LocalText
	this.File = file
...
func Init(isSave2LocalText bool) {
	infoLogHandle.Init("infors", false, "|", isSave2LocalText)
	errorLogHandle.Init("errors", true, "*", isSave2LocalText)
	waringLogHandle.Init("waring", true, "-", isSave2LocalText)
